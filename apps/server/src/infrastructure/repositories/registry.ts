...
import type { VolunteerNotificationRepository } from '../../domain/repositories/volunteer-notification.repository';
...
import { DrizzleMinistryRepository } from './drizzle-ministry.repository';
...
import { DrizzleVolunteerNotificationRepository } from './drizzle-volunteer-notification.repository';
import type { AnyDrizzleDb } from './types';

export interface Repositories {
  volunteers: VolunteerRepository;
  ministries: MinistryRepository;
  events: EventRepository;
  timeSlots: TimeSlotRepository;
  assignments: AssignmentRepository;
  assignmentAudits: AssignmentAuditRepository;
  availability: AvailabilityRepository;
  volunteerNotifications: VolunteerNotificationRepository;
...
export const repositories: Repositories = {
  ...
  ministries: new DrizzleMinistryRepository(typedDb),
  ...
  volunteerNotifications: new DrizzleVolunteerNotificationRepository(typedDb),
  roles: new DrizzleRoleRepository(typedDb),
  teams: new DrizzleTeamRepository(typedDb),
