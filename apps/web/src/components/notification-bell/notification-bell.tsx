  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        ...
        className="radius-icon relative flex h-8 w-8 items-center justify-center border border-border text-muted-foreground hover:bg-accent hover:text-accent-foreground"
      >
